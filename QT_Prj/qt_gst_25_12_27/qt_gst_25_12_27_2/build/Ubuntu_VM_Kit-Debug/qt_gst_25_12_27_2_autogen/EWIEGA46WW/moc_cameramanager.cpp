...
#include <memory>
#include "../../../../../../qt_gst_25_12_27_2/cameramanager.h"
...
QT_MOC_LITERAL(3, 26, 3) // "img"
    ...
    "CameraManager\0frameReady\0\0img"
};
...
void CameraManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraManager::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraManager::frameReady)) {
                *result = 0;
                return;
            }
        }
